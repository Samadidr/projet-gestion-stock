                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="align-middle"><img width='50' height='50'
                                                        ...
                                                        title='<?=$t->get("l")?>' style="border-radius:6px; object-fit:cover;"></td>
                                                <td class="align-middle font-weight-bold"><?=$t->get("r")?></td>
                                                <td class="align-middle"><?=$t->get("l")?></td>
                                                <td class="align-middle"><?=$t->get("p")?> MAD</td>
                                                <td class="align-middle">
                                                    <?php $q = (int)$t->get("q");
                                                        if($q <= 5) { ?>
                                                            <span class="badge-menu-count" title="Quantité faible"><?=$q?> en stock</span>
                                                        <?php } else { ?>
                                                            <span><?=$q?></span>
                                                        <?php } ?>
                                                </td>
                                                <td class="align-middle"><?=$t->get("a")?> MAD</td>
                                                <td class="align-middle"><?=$t->get("c")?></td>

                                                <td class="align-middle">
                                                    <a class="btn btn-sm btn-outline-primary me-1" data-bs-toggle="modal" data-bs-target="#update<?=$t->get("r")?>" title="Modifier">
                                                        <svg class="bi" width="1em" height="1em" fill="currentColor">
                                                            <use xlink:href="../../assets/images/bootstrap-icons.svg#pencil"></use>
                                                        </svg>
                                                    </a>

                                                    <a class="btn btn-sm btn-outline-danger" data-bs-toggle="modal" data-bs-target="#supprimer<?=$t->get("r")?>" title="Supprimer">
                                                        <svg class="bi" width="1em" height="1em" fill="currentColor">
